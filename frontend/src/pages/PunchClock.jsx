...
export default function PunchClock() {
  ...
  const showToast = useCallback((type, message) => {
    ...
    window.clearTimeout(window.__punchToastTimer);
    window.__punchToastTimer = window.setTimeout(() => {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <StatBox
              ...
              label="Punch In"
              value={
                records?.[0]?.punchedInAt
                  ? prettyTime(records?.[0]?.punchedInAt)
                  : "—"
              }
            />
            ...
            <StatBox
              ...
              label="Punch Out"
              value={
                records?.[0]?.punchedOutAt
                  ? prettyTime(records?.[0]?.punchedOutAt)
                  : "—"
              }
            />
            ...
            <StatBox
              ...
              icon={<Timer size={16} />}
              label="Worked"
              value={minutesToHM(totalMinutesToday)}
            />
          </div>
          ...
          <AnimatePresence>
            {!canPunchIn && !!punchInDisabledReason && (
              ...
              >
                <AlertTriangle
                  size={18}
                  style={{ color: ui.amber, marginTop: 1 }}
                />
                <div>
        ...
        >
          ...
          >
            • Only one Punch In per day
            <br />
            • Punch Out ends the day
            <br />
          ...
          >
            <div style={{ fontWeight: 900, fontSize: 12, color: ui.mut }}>
                ...
                records.map((r, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Td ui={ui}>
                        {r?.punchedOutAt ? prettyTime(r?.punchedOutAt) : "—"}
                      </Td>
                      <Td ui={ui}>
                        {r?.punchedOutAt ? minutesToHM(r?.totalMinutes) : "—"}
                      </Td>
                      <Td ui={ui}>
                        <span style={{ fontWeight: 950, color: statusColor }}>
                          {status}
                        </span>
                      </Td>
                    </motion.tr>
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{ fontSize: 12, fontWeight: 900, color: ui.mut }}>
            {label}
          </div>
        </div>
